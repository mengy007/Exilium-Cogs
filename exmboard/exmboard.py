...
class ExmBoard:
    ...
    async def exmboard(self, ctx, scope, stat, limit = 0):
        ...
        if scope == 'all' and stat not in ['saviorKill', 'scoreComba', 'scoreAssaul', 'wlPercentag', 'scoreGenera', 'ran', 'scoreAwar', 'headshot', 'shotsAccurac', 'assistsAsKill', 'longestHeadsho', 'dogtagsTake', 'draw', 'scoreDefensiv', 'scoreSqua', 'avengerKill', 'losse', 'revivesRecieve', 'round', 'killStrea', 'death', 'damag', 'scoreLan', 'assist', 'scoreReco', 'squadWipe', 'timePlaye', 'repair', 'scoreAi', 'scoreSuppor', 'heal', 'resupplie', 'scoreBonu', 'squadSpawn', 'damagePerMinut', 'rankScor', 'scoreRoun', 'killsPerMinut', 'ordersComplete', 'shotsHi', 'aceSqua', 'scorePerMinut', 'scoreTransport', 'shotsTake', 'scoreObjectiv', 'scoreMedi', 'suppressionAssist', 'roundsPlaye', 'killsAggregate', 'kill', 'revive', 'scoreTank', 'win', 'kdRatio']:
            ...
            return await self.bot.say("`Supported stats are 'saviorKill', 'scoreComba', 'scoreAssaul', 'wlPercentag', 'scoreGenera', 'ran', 'scoreAwar', 'headshot', 'shotsAccurac', 'assistsAsKill', 'longestHeadsho', 'dogtagsTake', 'draw', 'scoreDefensiv', 'scoreSqua', 'avengerKill', 'losse', 'revivesRecieve', 'round', 'killStrea', 'death', 'damag', 'scoreLan', 'assist', 'scoreReco', 'squadWipe', 'timePlaye', 'repair', 'scoreAi', 'scoreSuppor', 'heal', 'resupplie', 'scoreBonu', 'squadSpawn', 'damagePerMinut', 'rankScor', 'scoreRoun', 'killsPerMinut', 'ordersComplete', 'shotsHi', 'aceSqua', 'scorePerMinut', 'scoreTransport', 'shotsTake', 'scoreObjectiv', 'scoreMedi', 'suppressionAssist', 'roundsPlaye', 'killsAggregate', 'kill', 'revive', 'scoreTank', 'win', 'kdRatio'`")
