        ...
        try:
            ...
            for player in sortedPlayers:
                ...
                if count < 4:
                    ...
                    d.text(((bigW / 2) - w - 50, textY), value, font=fnt, fill="rgb(255,255,255)")
...
async def create_placed_image(self, ctx, player, scope, stat, place, value):
    ...
    w, h=d.textsize(value, font=headerFont)
    d.text((int(250 - (w / 2)), 375), value, font=headerFont, fill="rgb(255,255,255)")
